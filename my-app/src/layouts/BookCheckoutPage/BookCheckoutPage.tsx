...
export const BookCheckoutPage = () => {
    ...
    const [isLoadingReview, setIsLoadingRevivew] = useState(false);
    ...
    useEffect(() => {
        const fetchUserCheckedOutBook = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                const bookCheckoutOut = await fetch(url, requestOptions);
                if (!bookCheckoutOut.ok) {
                    throw new Error("Something went wrong!");
                }
                const bookCheckedOutResponseJson = await bookCheckoutOut.json();
    ...
    if (isLoadingReview || isLoading || isLoadingCurrentLoansCount || isLoadingUserReview || isLoadingBookCheckedOut) {
        return (
            ...
            <div className="container d-none d-lg-block">
                ...
                <div className="row mt-5">
                    <div className="col-sm-2 col-md-2">
                        {
                            book?.img ?
                                <img src={book?.img} width='226' height='394' alt="Book" />
                                :
