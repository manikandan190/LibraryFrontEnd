...
export const AdminMessages = () => {
    ...
    //Normal Loading Piece
    const [isLoadingMessages, setIsLoadmingMessages] = useState(true);
    ...
    return (
        <div className="mt-3">
            ...
            {totalPages > 1 && <Pagination currentPage={currentPage} totalPages={totalPages} pagination={paginate} />
            }
        </div>
    )
}