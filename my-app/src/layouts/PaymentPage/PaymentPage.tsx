...
export const PaymentPage = () => {
    ...
    async function checkout() {
        ...
        const stripeReponse = await fetch(url, requestOptions);
        if (!stripeReponse.ok) {
            setHttpError(true);
        ...
        const stripeResponseJson = await stripeReponse.json();
        let confirmPayment = stripe.confirmCardPayment(
        ...
        <div className="container">
            ...
            }
            {
                ...
                <div className="mt-3">
                    ...
                    <Link type='button' className='btn main-color text-white' to='search'>Explore</Link>
                </div>
            }
            {
