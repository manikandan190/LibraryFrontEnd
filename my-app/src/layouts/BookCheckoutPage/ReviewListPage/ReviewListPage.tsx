...
export const ReviewListPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviewData = async () => {
        ...
        fetchBookReviewData().catch((error: any) => {
            setIsLoading(false);
    ...
    return (
        <div className="container mt-5">
            ...
            <p>
                {indexOfFirstReview + 1} to {totalAmountOfReviews} items:
            </p>
            <div className="row">
                {reviews.map(reviews => (
                    <Review review={reviews} key={reviews.id} />
                ))}
            </div>
