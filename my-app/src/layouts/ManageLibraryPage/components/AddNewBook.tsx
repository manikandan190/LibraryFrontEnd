                    ...
                    <form method="POST">
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                ...
                                <button className="from-control btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle='dropdown' aria-expanded='false'>
                                    {category}
                                </button>
                                <ul id='addNewBookId' className="dropdown-menu" aria-aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><a onClick={() => categoryField('BE')} className="dropdown-item">Backend End</a></li>
